...
//源站文件独立于bucket的权限
typedef NS_ENUM(NSInteger, TXYAuthorityType)
{
     /**采用bucket的权限 */
    eInvalidAuth = 0,
     /**文件私有读写的权限 */
...
//文件读写权限
@property(nonatomic,assign) TXYAuthorityType authorityType;
//视频信息
...
//源站文件的读写权限
@property(nonatomic,assign) TXYAuthorityType fileAuthority;
